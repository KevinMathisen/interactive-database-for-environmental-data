<script>
    ...
    onMount(async () => {
        ...
        let orretData = [8, 10, 20, 33, 25, 66, 70, 2, 70, 23, 25, 2, 32, 89, 28, 89, 23, 49, 48, 4];
        let harrData = [10, 23, 29, 83, 94, 39, 29, 49, 58, 29, 49, 70, 74, 57, 47, 37, 28, 54, 44, 27];
        let gjeddeData = [23, 47, 25, 45, 67, 35, 57, 2, 34, 45, 38, 35, 27, 18, 47, 73, 48, 29, 38, 28];

        //The displayed intervals for the x-axis
        let xValues = Array.from({length: 20}, (v, i) => (i * 10) + 5);
        ...
        let data = [traceOrret, traceHarr, traceGjedde, traceOrretLine, traceHarrLine, traceGjeddeLine];
