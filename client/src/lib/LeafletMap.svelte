<script>
    ...
    const stationMarkers = [] // Array to store stationmarkers used by the map
    const riverMarkers = [] // Array to store river markers used by the map
    const lines = [] // Array to store lines used by the map
    // let zoomChanged = 0;
    let clickedMarker
    let clickedRiver
    let markerIndex
