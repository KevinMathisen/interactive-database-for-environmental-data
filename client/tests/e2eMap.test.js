...
test.describe('Tests the map page', () => {
  test('Testing selecting riverpoint and summary table', async ({ page }) => {
    ...
    try {
      ...
      await page.screenshot({ path: 'screenshots/map/1-map-page.png' })

      await page.locator('.leaflet-marker-icon').first().click()
      await page.waitForTimeout(1000)
      await page.screenshot({ path: 'screenshots/map/2-river-popup.png' })

      await page.click('text=Info')
      await page.waitForTimeout(1000)
      await page.screenshot({ path: 'screenshots/map/3-collapse-info.png' })

      await page.getByRole('cell', { name: '1', exact: true }).click()
      await page.waitForTimeout(500)
      await page.screenshot({ path: 'screenshots/map/3-river-summary.png' })
