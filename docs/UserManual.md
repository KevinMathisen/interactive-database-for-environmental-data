...
Netsiden har 5 side; Kart, Liste, Graf, Last opp, Last ned. Disse sidene har ulike formål og bruksområder. For å bytte mellom de ulike sidene er det bare å trykke på navnet til siden man ønsker å gå til.
...
Dette viser at menyen kan åpnes og lukkes. Er man ferdig med alt som står under denne menyen, kan man lukke den for å oppnå mer plass.
...
I Dato feltet kan man sette en start dato (fra), en slutt dato (til), eller begge. Definerer man en start dato, så vises bare alle stasjonene/elvene som ble besøkt etter datoen. Setter man f.eks. start dato som 31. Desember 2015, så vil alle obervasjoner gjort før 2015 ikke vises på kartet. Setter man slutt dato til 1. Januar 2016, så vises bare obervasjoner før 2015. Setter man begge samtidig, så vises bare observasjoner gjort inne i interavellet. Setter man 31. Desember 2015 i fra, og 1. Januar 2016 i til så vil mest sannsynlig ingenting vises, siden intervallet bare er 2 dager (31 desember og 1. Januar ), og disse er fridager.
...
Det finnes flere valgmulighet for selv kartet. Det første et at man kan zoome inn og ut. Dette ser man øverst i høyre hjørne, men man kan også zoome på kartet ved bruk av mus/touchpad. Ved mus så må man "scrolle" med hjulet mellom venstre klikk og høyre klikk, mens på touchpad så man må knipe fingrene sammen/fra hverandre. På bildet under er det zoomet inn på stasjonspunktne i elven Gaula. 
...
Alle punktene på interaktive, som vil si at man kan trykke på de. Trykker man på et punkt for man opp all dataen for det punktet. Dataen varierer utifra om man har trykket på et elvedatapunkt eller et stasjonsdatapunkt. En stasjon består som sagt av to punkter og en linje, men det telles som et objekt. Trykker man på start/slutt punktet, så vises samme data. Valgte punktet er oransje, dette gjelder for både elver og stasjoner.
...
Liste siden fungerer veldig likt som kart siden, men istedenfor at alle stasjonene/elvene er plassert på et kart utifra sine kordinater, ligger de nå i en lang liste. Dette er ideelt hvis man ønsker å søke etter en spesefikk stasjon som man ikke helt vet hvor er.
...
For å velge dataene man ønsker å laste ned trykker man på "rediger elver". Dette gjør man uavhengig om man ønsker stasjonsdata eller elvedata.
...
Det siste feltet på denne siden er der man faktisk bestemmer hvilke data man vil laste ned. Det er et søkefelt, og alle stasjoner/elver som passer til søket vil vises. Husk, man får ikke opp stasjoner og elver, valgte man elvedata på det først feltet kan man bare søke etter elver, og valgte man stasjonsdata kan man bare søke etter stasjoner. Søkefeltet er ikke case-sensetiv og viser alle resultater som inneholder søkemønsteret som har blitt valgt. Velger man for eksempel bare å søke "a", så får man opp alle elver/stasjoner som innehoder bokstaven "a" eller "A". I dette tilfelle ønsker jeg å se noen av målingene gjort i elven Gaula. Jeg velger derfor stasjonsdata, og søker på "Ga". Jeg kunne søkt på "Gaula", men det var ingen andre stasjoner som inneholdt "Ga", så dette holdt for å få de stasjonene jeg trengte.

![Download](/images/Download4.png "Download")

For å velge stasjonene man ønsker er det bare å trykke på de. Da dukker de opp under søkefeltet, under "Stasjoner valgt". Her kan man fjerne de, hvis man ved et uhell trykket feil kan man fjerne stasjonen ved å trykke på X-en. Noe å merke seg, er at man må gjenta søket for hver stasjon man ønsker å legge til. Hadde jeg vært usikker på hvilke av stasjonen i Gaule jeg ønsket å laste ned, så kunne jeg for eksempel brukt kartsiden og funnet stasjonene i Gaula, slik som vist under.
...
Når man har valgt elvene/stasjonene man ønsker å laste ned. Så trykker man trykke på X-en øverst i høyre hjørne, eller trykke bare trykke utenfor selve meny-boksen.

Det neste å tenke på er om man ønsker hvilke arter som man vil inkludere når man laster ned.
